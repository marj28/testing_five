  ...
  <v-card id="Employer">
      ...
      <v-stepper-items>
        ...
        <v-stepper-content step="1">
          ...
          <v-btn
            id="v-btn-c"
            class="ma-4"
            @click="$router.push({ path: 'AvailableTraining' })"
            color="success"
            outlined
          >
            Cancel
            ...
            <v-card-text>
              <v-container fluid>
                <v-row>
                  ...
                  <v-col cols="12" sm="12" md="3" class="ma-2">
                    <v-checkbox-group>
                      <v-checkbox label="STAND" color="success"></v-checkbox>
                      <v-checkbox
                        label="TADS"
                        style="margin-top: -10px"
                        color="success"
            ...
            <v-card-text>
              <v-container fluid>
                <v-row>
                  ...
                  <v-col cols="12" sm="12" md="6" id="step2">
                    <v-radio-group row>
                      <v-radio
                        label="Employed"
                        color="success"
                      ...
                      <v-col>
                        ...
                        <v-radio-group row>
                          <v-radio
                            label="Yes"
                            value="yes"
                            @click="preffered_occupationLocal = true"
                            class="ma-2 pa-2"
                            color="success"
                          ></v-radio>
                          <v-container v-show="preffered_occupationLocal">
                            <v-text-field
                        ...
                        <v-radio-group row>
                          <v-radio
                            label="Yes"
                            value="yes"
                            @click="preffered_occupationAbroad = true"
                            class="ma-2 pa-2"
                            color="success"
                          ></v-radio>
                          <v-container v-show="preffered_occupationAbroad">
                            <v-text-field
                              label="Preffered occupation? "
                              outlined
                              color="success"
                ...
                <v-row>
                  ...
                  <v-col cols="12" md="2">
                    <v-btn
                      color="error"
                      outlined
                      @click="WorkHistoryRemoveRow(index)"
                    >
                      Remove
                    </v-btn>
                    <v-btn color="warning" @click="WorkHistoryAddRow">
                      Add
                    </v-btn>
                  </v-col>
                </v-row>
        ...
        <v-stepper-content step="5">
                ...
                <v-row>
                  ...
                  <v-row cols="12" sm="2" md="12" class="ma-2">
                    <v-col cols="12" sm="12" md="12" id="move">
                      <p class="font-weight-bold green--text">SECONDARY</p>
                    </v-col>
                    <v-spacer></v-spacer>
                    <v-text-field
                      outlined
          ...
          <v-btn @click="e1 = 4" class="ma-2" color="success" outlined>
            Back
          </v-btn>
        </v-stepper-content>
        ...
        <v-stepper-content step="6">
                    ...
                    <v-row>
                      ...
                      <v-col cols="12" md="3">
                        <v-text-field
                          ...
                          dense
                          color="success"
                          v-model="item.training_provider"
                        >
                        </v-text-field>
                      </v-col>
                      ...
                      <v-col cols="12" md="2">
                        ...
                        <v-btn
                          color="warning"
                          @click="VocationalTrainingAddRow"
                        >
                          Add
                        </v-btn>
                      </v-col>
          ...
          <v-btn id="v-btn-c" color="warning" @click="e1 = 7"> Continue </v-btn>
          <v-btn @click="e1 = 5" class="ma-2" color="success" outlined>
            Back
          </v-btn>
        </v-stepper-content>
        ...
        <v-stepper-content step="7">
              ...
              <v-container fluid>
                <v-row>
                  <v-col cols="12" sm="12" md="4">
                    <v-checkbox-group>
                      <v-checkbox
                        label="Call Center 101 Training"
                        color="success"
                      ></v-checkbox>
                      <v-checkbox
                        label="Visual Graphic Designing"
                        color="success"
                        style="margin-top: -10px"
                      ></v-checkbox>
                      <v-checkbox
                      ...
                      ></v-checkbox>
                      <v-checkbox
                        label="Appointment Setting Bookkeeping"
                        color="success"
                        style="margin-top: -10px"
                      ></v-checkbox>
                      <v-checkbox
          ...
          <v-btn id="v-btn-c" color="success" @click="dialogSave = true"> Save </v-btn>
          <v-btn @click="e1 = 6" class="ma-2" color="success" outlined>
            Back
          </v-btn>
        </v-stepper-content>
      </v-stepper-items>
    ...
    <v-row>
      <v-dialog v-model="dialogSave" max-width="290">
        <v-card>
          <v-card-title class="text-h5"> PROJECT UPDATE REGISTRATION </v-card-title>
          <v-divider />
          <v-card-text class="pa-4">
            You have registered your information in the CBTED Program. Do you want to save or
            discard it?
          </v-card-text>
...
export default {
  ...
  setup() {
    ...
    const WorkHistoryRemoveRow = (index) => {
      if (form.length > 1) {
        form.splice(index, 1);
      }
    };
    const forms = reactive([
      { training_course: "", duration: "", training_provider: "" },
    ]);
    const VocationalTrainingAddRow = () => {
      forms.push({ training_course: "", duration: "", training_provider: "" });
    };
  ...
  data() {
    return {
      ...
      employed: false,
      unemployed: false,
      preffered_occupationLocal: false,
      preffered_occupationAbroad: false,
      dialogSave: false,
