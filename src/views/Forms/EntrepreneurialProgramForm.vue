<template>
  <v-app>
    <v-main>
      <v-card id="Employer">
        <v-card-title>
          <span class="text-h7">ENTREPRENEURIAL PROGRAM REGISTRATION FORM</span>
        </v-card-title>
        <v-stepper v-model="e1">
          ...
          <v-stepper-items>
                ...
                <v-card-text>
                  <v-container>
                    <v-row>
                      ...
                      <v-col cols="12" sm="12" md="3">
                        <v-text-field label="Place of Birth" outlined>
                        </v-text-field>
                      </v-col>
                      <v-col cols="12" sm="6" md="3">
                        <v-text-field label="Cellphone Number" outlined>
                        </v-text-field>
                      </v-col>
                      <v-col cols="12" sm="6" md="3">
            ...
            <v-stepper-content step="3">
                    ...
                    <v-row>
                      ...
                      <v-row cols="12" sm="12" md="6">
                        <v-container>
                          ...
                          <v-col cols="12" sm="12" md="12">
                            <v-text-field
                              label="If Yes, what is your preferred occupation? "
                              outlined
                            ></v-text-field>
                          </v-col>
                        </v-container>
              ...
              <v-btn id="v-btn-c" color="secondary" @click="e1 = 4">
                Continue
              </v-btn>
            ...
            <v-stepper-content step="4">
                    ...
                    <v-col md="12">
                      <v-row style="margin-top: 10px">
                        ...
                        <v-text-field
                          ...
                          outlined
                        ></v-text-field>
                        <v-text-field label="Status" outlined></v-text-field>
                      </v-row>
                    </v-col>
                  </v-container>
                </v-card-text>
              ...
              <v-btn id="v-btn-c" color="secondary" @click="e1 = 5">
                Continue
              </v-btn>
            ...
            <v-stepper-content step="5">
                    ...
                    <v-row>
                      ...
                      <v-row cols="12" sm="2" md="12" class="ma-2">
                        <v-col cols="12" sm="12" md="12" id="move">
                          <p class="font-weight-bold">SECONDARY</p>
                        </v-col>
                        <v-spacer></v-spacer>
                        <v-text-field outlined label="School"> </v-text-field>
                        <v-text-field outlined label="Course"> </v-text-field>
                        <v-text-field outlined label="Year Graduated">
                        </v-text-field>
                        <v-text-field
              ...
              <v-btn id="v-btn-c" color="secondary" @click="e1 = 6">
                Continue
              </v-btn>
            ...
            <v-stepper-content step="6">
              ...
              <v-btn id="v-btn-c" color="secondary" @click="e1 = 7">
                Continue
              </v-btn>
            ...
            <v-stepper-content step="7">
              <v-card class="mb-12" color="grey lighten-4">
                <v-card-text>
                  <h4 class="font-weight-bold">
                    Entrepreneurial Training Application (Check your desired
                    training)
                  </h4>
                  <v-container fluid>
                    <v-row>
                      <v-col cols="12" sm="12" md="3">
                        <v-checkbox-group>
                          <v-checkbox
                            label="Balloon Twisting Training"
                          ></v-checkbox>
                          <v-checkbox
                            label="Banana Chips Training"
                            style="margin-top: -10px"
                          ></v-checkbox>
                          <v-checkbox
                            label="Bangus Deboning"
                            style="margin-top: -10px"
                          ></v-checkbox>
                          <v-checkbox
                            label="Basic Haircut and Hairdo Training"
                            style="margin-top: -10px"
                          ></v-checkbox>
                          <v-checkbox
                            label="Basic Layout Designing"
                            style="margin-top: -10px"
                          ></v-checkbox>
                          <v-checkbox
                            label="Basic Nail Care Training"
                            style="margin-top: -10px"
                          ></v-checkbox>
                          <v-checkbox
                            label="Bath Soap Training"
                            style="margin-top: -10px"
                          ></v-checkbox>
                          <v-checkbox
                            label="Bottled Sardines Making"
                            style="margin-top: -10px"
                          ></v-checkbox>
                          <v-checkbox
                            label="Brownies and Butter Scotch Making"
                            style="margin-top: -10px"
                          ></v-checkbox>
                        </v-checkbox-group>
                        <v-textfield label="Others" outlined></v-textfield>
                      </v-col>
                      <v-col cols="12" sm="12" md="3">
                        <v-checkbox-group>
                          <v-checkbox label="Cake Making"></v-checkbox>
                          <v-checkbox
                            label="Candle Making"
                            style="margin-top: -10px"
                          ></v-checkbox>
                          <v-checkbox
                            label="Center Balloon Designing"
                            style="margin-top: -10px"
                          ></v-checkbox>
                          <v-checkbox
                          ...
                          ></v-checkbox>
                          <v-checkbox
                            label="Concentrated Calamansi"
                            style="margin-top: -10px"
                          ></v-checkbox>
                          <v-checkbox
                            label="Detergent Powder Making"
                            style="margin-top: -10px"
                          ></v-checkbox>
                          <v-checkbox
                            label="Dishwashing Making"
                            style="margin-top: -10px"
                          ></v-checkbox>
                          <v-checkbox
                            label="Embotido Making"
                            style="margin-top: -10px"
                          ></v-checkbox>
                          <v-checkbox
                            label="Empanada Making"
                            style="margin-top: -10px"
                          ></v-checkbox>
                        </v-checkbox-group>
                      </v-col>
                      <v-col cols="12" sm="12" md="3">
                        <v-checkbox-group>
                          <v-checkbox
                            label="Fabric Conditioner Making"
                          ></v-checkbox>
                          <v-checkbox
                            label="Fashion Accessories Making"
                            style="margin-top: -10px"
                          ></v-checkbox>
                          <v-checkbox
                          ...
                          ></v-checkbox>
                          <v-checkbox
                            label="Garland and Bouquet Making"
                            style="margin-top: -10px"
                          ></v-checkbox>
                          <v-checkbox
                            label="Ham Making"
                          ...
                          ></v-checkbox>
                          <v-checkbox
                            label="Kakanin Making (Kutsinta, Biko and Palitaw)"
                            style="margin-top: -10px"
                          ></v-checkbox>
                          <v-checkbox
                            label="Key Chain Making"
                            style="margin-top: -10px"
                          ></v-checkbox>
                          <v-checkbox
                            label="Mango Puree Making"
                            style="margin-top: -10px"
                          ></v-checkbox>
                          <v-checkbox
                            label="Mushroom Production Training"
                            style="margin-top: -10px"
                          ></v-checkbox>
                        </v-checkbox-group>
                      </v-col>
                      <v-col cols="12" sm="12" md="3">
                        <v-checkbox-group>
                          <v-checkbox label="Paper Bag Making"></v-checkbox>
                          <v-checkbox
                            label="Perfume Making"
                            style="margin-top: -10px"
                          ></v-checkbox>
                          <v-checkbox
                            label="Pickles Making"
                            style="margin-top: -10px"
                          ></v-checkbox>
                          <v-checkbox
                            label="Puto Flan and Puto Cheese Making"
                            style="margin-top: -10px"
                          ></v-checkbox>
                          <v-checkbox
                            label="Rug Making"
                          ...
                          ></v-checkbox>
                          <v-checkbox
                            label="Table and Skirting"
                            style="margin-top: -10px"
                          ></v-checkbox>
                          <v-checkbox
                            label="Tocino and Longganisa Making"
                            style="margin-top: -10px"
                          ></v-checkbox>
                          <v-checkbox
                            label="T-shirt Making"
                            style="margin-top: -10px"
                          ></v-checkbox>
                        </v-checkbox-group>
                      </v-col>
              ...
              <v-btn id="v-btn-c" color="secondary" @click="e1 = 8">
                Continue
              </v-btn>
