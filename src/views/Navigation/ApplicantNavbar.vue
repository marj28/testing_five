  ...
  export default {
    data: () => ({
      ...
      items: [
        ...
        { icon: "mdi-home", text: "Job Applications", route: "/StudentDashboard" },
        { icon: "mdi-home", text: "Training Applications", route: "/StudentDashboard" },
        { icon: "mdi-home", text: "Print PDS", route: "/StudentDashboard" },
